...
echo "AI Director переработан под 12 практических пунктов с последовательной генерацией через Groq."
echo "Автомонтаж кнопка добавлена в редактор — использует весь исходный материал."
echo "Весь код бесплатен, использует Groq API и локальные технологии."
