...
export default function SoundPanelV2() {
  ...
  const Slider = ({ label, value, min, max, step, onChange }: any) => (
    <div className="mb-2">
      <div className="flex justify-between text-[10px] font-medium text-slate-300 mb-0.5"><span>{label}</span><span className="text-amber-300">{value}</span></div>
  ...
  return (
    <div className="space-y-3">
      <section className="rounded-xl bg-[#0d0d16] border border-white/10 p-3 shadow-inner">
        <h3 className="text-xs font-bold text-amber-300 mb-2">Громкость и Фейды</h3>
      ...
      <section className="rounded-xl bg-[#0d0d16] border border-white/10 p-3 shadow-inner">
        <h3 className="text-xs font-bold text-amber-300 mb-2">Эквалайзер</h3>
      ...
      <section className="rounded-xl bg-[#0d0d16] border border-white/10 p-3 shadow-inner">
        <h3 className="text-xs font-bold text-amber-300 mb-2">Профессиональные инструменты</h3>
      ...
      <section className="rounded-xl bg-[#0d0d16] border border-white/10 p-3 shadow-inner">
        <h3 className="text-xs font-bold text-amber-300 mb-2">Компрессор</h3>
