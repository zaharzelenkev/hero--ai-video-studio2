...
export const STYLE_CHIPS: { label: string; hint: string }[] = [
  ...
  { label: "🎙️ Подкаст", hint: "смонтируй подкаст: перебивки b-roll, субтитры, чистый звук" },
  { label: "🎤 Интервью", hint: "смонтируй интервью: крупные планы, нижние титры, вырезать паузы" },
